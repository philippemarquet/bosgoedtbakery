                ...
                <>
                  ...
                  {categoryProducts.map((product) => (
                    <TableRow key={product.id} className="border-0 hover:bg-muted/30">
                      ...
                      <TableCell className="py-2.5 text-sm font-light">{product.name}</TableCell>
                      ...
                      <TableCell className={`py-2.5 text-right text-sm tabular-nums ${getMarginColor(product.totalCost || 0, Number(product.selling_price))}`}>
