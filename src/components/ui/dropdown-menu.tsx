...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-[calc(var(--radius)-4px)] px-2.5 py-1.5 text-sm outline-none transition-colors data-[state=open]:bg-muted/60 focus:bg-muted/60",
      inset && "pl-8",
      className,
    )}
    {...props}
